function BK_execute_SPM_batch_layers_main_allrun(tmppath,subjpath,structpath,multi_regfile,typofcompcor,hpfiltcutoff)
...
matlabbatch{2}.spm.tools.rwls.fmri_rwls_est.write_residuals = 1; % set to 1 to keep residuals
