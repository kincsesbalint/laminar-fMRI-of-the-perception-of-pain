function BK_execute_SPM_batch_UNsmoothedmaindata(tmppath,subjpath,structpath,multi_regfile,typofcompcor,hpfiltcutoff)
...
stats_path = [tmppath '/' typofcompcor '_UNsmoothed'];
